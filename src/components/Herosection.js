          ...
          <div class="container">
            <div class="grid-container">
              <div class="product-info">
                <h1 class="product-title accelerateheading ">
                Print on demand for your ecommerce business
                </h1>
                <h3 className="herosignup">Sign up for free and only pay for what you sell</h3>
                <p className="marginherosec">
                  Turn your passion into profit with the world's largest print
                  on demand network
                </p>
                <div className="flex">
                  <button className="btn mr-2">Get started for Free</button>
                ...
                0L8.397 8.387l-4.552.361c-1.775.14-2.495 2.331-1.142 3.477l3.468 2.937-1.06 4.392c-.413 1.713 1.472 3.067 2.992 2.149L12 19.35l3.897 2.354c1.52.918 3.405-.436 2.992-2.15l-1.06-4.39 3.468-2.938c1.353-1.146.633-3.336-1.142-3.477l-4.552-.36-1.754-4.17Z"
                        />
                      </svg>
                      <svg
                        class="star"
